...
{
    public partial class FormHomeKeToan : Form
    {
        //Fields
        ...
        private void btn_tiepnhanhd_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormsofKeToan.FormQuanLyHoaDon(), sender);
        }

        private void btn_inhd_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Report.FormInHoaDon(), sender);
        }
