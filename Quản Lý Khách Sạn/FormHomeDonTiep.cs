...
{
    public partial class FormHomeDonTiep : Form
    {
        //Fields
        ...
        private void btn_timkiemnangcao_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormsofLeTan.FormTimKiemNangCao(), sender);
        }

        private void btn_thanhtoan_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormsofLeTan.FormThanhToan(), sender);
        }

        private void btn_dkdichvu_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormsofLeTan.FormDangKiDichVu(), sender);
        }

        private void btn_dkphong_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormsofLeTan.FormDangKiPhong(), sender);
        }
