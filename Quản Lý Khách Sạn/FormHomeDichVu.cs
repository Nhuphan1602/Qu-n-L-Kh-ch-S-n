...
{
    public partial class FormHomeDichVu : Form
    {
        //Fields
        ...
        {
            OpenChildForm(new FormsofDichVu.FormQuanLyDichVu(), sender);
        }

        private void btn_quanlyphong_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormsofDichVu.FormQuanLyPhong(), sender);
        }

        private void btn_xldichvu_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormsofDichVu.FormXuLyDichVu(), sender);
        }
